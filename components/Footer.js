    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              The most up-to-date and reliable used car news portal
            </p>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4 text-red-500">Quick Links</h4>
            <ul className="space-y-3">
              {['News', 'Used Cars', 'Market Analysis'].map((item) => (
                <li key={item}>
                  <Link 
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-red-500">Social Media</h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; 2024 Used Cars. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
